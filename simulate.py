    ...
    try:
        ...
        parser.add_argument("--tempfiles_output_dir", nargs="?",
            help="optional directory where CBM tempfiles will be copied "
                 ...
                 "used.")
        parser.add_argument("--skip_makelist", nargs="?",
            help="If set to true, then skip running makelist. Useful for "
        ...
        parser.add_argument("--use_existing_makelist_output", nargs="?",
            help="if set to True, the existing values in the project "
