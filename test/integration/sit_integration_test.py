    ...
    def test_integration(self):
        ...
        with tempfile.TemporaryDirectory() as tempdir:
            ...
            xls_project = import_mdb_xls(
                xls_working_dir, sit_xls_path, mapping_file_path, xls=True
            )
            ...
            run_args = [
                dict(
                    project_path=mdb_project, results_database_path=mdb_results
                ),
                dict(
                    project_path=xls_project, results_database_path=xls_results
                ),
                dict(
                    project_path=csv_project, results_database_path=csv_results
                ),
                dict(
                    project_path=tab_project, results_database_path=tab_results
                ),
            ]
            for arg in run_args:
