...
def create(output_path, base_project_dir, project_prefixes, results_dir="RESULTS"):
    '''
    ...
    with open(output_path, 'w') as csvfile:
        ...
        for project_prefix in project_prefixes:
            row = {
                ...
                "project_path": get_base_project_path(base_project_dir, project_prefix),
                "results_path": get_base_run_results_path(base_project_dir, project_prefix, results_dir)
                }
            writer.writerow(row)
