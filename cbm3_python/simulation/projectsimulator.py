...
def run(aidb_path, project_path, toolbox_installation_dir, cbm_exe_path,
    ...
    @param copy_makelist_results if set to True, makelist *svl output is
           directly copied from the makelist output dir to the cbm input dir
           rather than using the toolbox load svl and dump svl procedures
           This is the current NIR procedure for all but the AF project.
