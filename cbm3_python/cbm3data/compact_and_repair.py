...
def compact_and_repair(access_db_path):
    '''
    Runs the compact & repair function on the database at the specified
    access_db_path.
    mostly borrowed from:
    https://stackoverflow.com/questions/39083000/find-all-access-databases-and-compact-and-repair
    '''
    # LAUNCH ACCESS APP
    ...
    if ext.lower() not in [".mdb", ".accdb"]:
        raise ValueError(
            "specified extension ({}) not supported for compact & repair"
            .format(ext))
